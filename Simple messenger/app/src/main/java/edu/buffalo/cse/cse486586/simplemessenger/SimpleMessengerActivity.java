...
/**
 * Reference: JavaTpoint.com for socket
 */
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            try {
                ...
                while(true) {
                    ...
                    Log.e(TAG, "Server accepting clients message");
                    DataInputStream dis = new DataInputStream(s.getInputStream());
                    String  str = dis.readUTF();
                    Log.e(TAG, "Server read clients message");
                    DataOutputStream outputStream = new DataOutputStream(s.getOutputStream());
                    outputStream.writeUTF("ACK");
                    Log.e(TAG, "Server sent ACK message");
                    publishProgress(str);
                    Log.e(TAG, "Server sent string message");
                    outputStream.flush();
                    outputStream.close();
                    s.close();
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                Log.e(TAG, "Sent Message from client");
                dout.flush();
